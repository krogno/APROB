...
void Settings(void)
{
	...
	while(OSCCONbits.LOCK!=1) {};		// Wait for PLL to lock
		...
		TRISBbits.TRISB12 = 0; // moteur
		TRISBbits.TRISB13 = 0; // moteur
		...
		// Configuration PWM
		RPOR6bits.RP12R = 0b10010; // OC1 sur B12
		RPOR6bits.RP13R = 0b10011; // OC2 sur B13
		RPOR7bits.RP14R = 0b10100; // OC3 sur B14
		RPOR7bits.RP15R = 0b10101; // OC4 sur B15

                // Configuration UART
                RPINR19bits.U2RXR = 4;// RX2 sur RP4
                RPOR3bits.RP7R = 0b00101;// pour TX2 -- 0b00011;// TX1 sur RP7 --
