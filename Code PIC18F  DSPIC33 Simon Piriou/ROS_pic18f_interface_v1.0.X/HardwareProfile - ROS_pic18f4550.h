...
#define HARDWARE_PROFILE_PICDEM_FSUSB_H
	...
	#define RCLKPin  LATBbits.LATB1 // Pin connected to RCLK -- storage register clock pin (latch pin) -- of 74HC595
	...
	#define mInit74HC595()  LATB &= 0b11111000; TRISB &= 0b11111000;
