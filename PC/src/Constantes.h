...
#define ROBOT_UNICYCLE_TAUX_ACCROISSEMENT_VITESSE_LINEAIRE_TOURNER       (ROBOT_UNICYCLE_VITESSE_LINEAIRE_ROTATION_MAX-ROBOT_UNICYCLE_VITESSE_LINEAIRE_ROTATION_MIN)/ROBOT_UNICYCLE_ANGLE_SEUIL_VITESSE_MAX
