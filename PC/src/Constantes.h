...
#define ROBOT_UNICYCLE_VITESSE_MOTEUR_GAUCHE_AVANCER_MAX  ROBOT_UNICYCLE_VITESSE_AVANCER_MAX/ROBOT_UNICYCLE_RAYON_GAUCHE
#define ROBOT_UNICYCLE_VITESSE_MOTEUR_DROITE_AVANCER_MAX  ROBOT_UNICYCLE_VITESSE_AVANCER_MAX/ROBOT_UNICYCLE_RAYON_DROITE
#define ROBOT_UNICYCLE_VITESSE_MOTEUR_GAUCHE_AVANCER_MIN  ROBOT_UNICYCLE_VITESSE_AVANCER_MIN/ROBOT_UNICYCLE_RAYON_GAUCHE
#define ROBOT_UNICYCLE_VITESSE_MOTEUR_DROITE_AVANCER_MIN  ROBOT_UNICYCLE_VITESSE_AVANCER_MIN/ROBOT_UNICYCLE_RAYON_DROITE

#define ROBOT_UNICYCLE_VITESSE_MOTEUR_GAUCHE_TOURNER_MAX  ROBOT_UNICYCLE_VITESSE_TOURNER_MAX*2*M_PI*2*ROBOT_UNICYCLE_DISTANCE_ROUES/ROBOT_UNICYCLE_RAYON_GAUCHE
#define ROBOT_UNICYCLE_VITESSE_MOTEUR_DROITE_TOURNER_MAX  ROBOT_UNICYCLE_VITESSE_TOURNER_MAX*2*M_PI*2*ROBOT_UNICYCLE_DISTANCE_ROUES/ROBOT_UNICYCLE_RAYON_DROITE
#define ROBOT_UNICYCLE_VITESSE_MOTEUR_GAUCHE_TOURNER_MIN  ROBOT_UNICYCLE_VITESSE_TOURNER_MIN*2*M_PI*2*ROBOT_UNICYCLE_DISTANCE_ROUES/ROBOT_UNICYCLE_RAYON_GAUCHE
#define ROBOT_UNICYCLE_VITESSE_MOTEUR_DROITE_TOURNER_MIN  ROBOT_UNICYCLE_VITESSE_TOURNER_MIN*2*M_PI*2*ROBOT_UNICYCLE_DISTANCE_ROUES/ROBOT_UNICYCLE_RAYON_DROITE

#define ROBOT_UNICYCLE_TAUX_ACCROISSEMENT_VITESSE_MOTEUR_GAUCHE_AVANCER  (ROBOT_UNICYCLE_VITESSE_MOTEUR_GAUCHE_AVANCER_MAX-ROBOT_UNICYCLE_VITESSE_MOTEUR_GAUCHE_AVANCER_MIN)/ROBOT_UNICYCLE_DISTANCE_SEUIL_VITESSE_MAX
#define ROBOT_UNICYCLE_TAUX_ACCROISSEMENT_VITESSE_MOTEUR_DROITE_AVANCER  (ROBOT_UNICYCLE_VITESSE_MOTEUR_DROITE_AVANCER_MAX-ROBOT_UNICYCLE_VITESSE_MOTEUR_DROITE_AVANCER_MIN)/ROBOT_UNICYCLE_DISTANCE_SEUIL_VITESSE_MAX

#define ROBOT_UNICYCLE_TAUX_ACCROISSEMENT_VITESSE_MOTEUR_GAUCHE_TOURNER  (ROBOT_UNICYCLE_VITESSE_MOTEUR_GAUCHE_TOURNER_MAX-ROBOT_UNICYCLE_VITESSE_MOTEUR_GAUCHE_TOURNER_MIN)/ROBOT_UNICYCLE_ANGLE_SEUIL_VITESSE_MAX
#define ROBOT_UNICYCLE_TAUX_ACCROISSEMENT_VITESSE_MOTEUR_DROITE_TOURNER  (ROBOT_UNICYCLE_VITESSE_MOTEUR_DROITE_TOURNER_MAX-ROBOT_UNICYCLE_VITESSE_MOTEUR_DROITE_TOURNER_MIN)/ROBOT_UNICYCLE_ANGLE_SEUIL_VITESSE_MAX
